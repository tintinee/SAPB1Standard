						...
						<label for="inputEmail3" class="col-sm-4 col-form-label " style="color: black; font-size:15px" class="labeludf" >'.odbc_result($qry, 'Descr').'</label>
							<div  class="col-sm-8 input-group mb-1 udfdiv">
								...
								<div class="col-sm input-group mb-1 ">
									<input type="text" class="form-control col-10 '.$inputID.'"  value="" min="01-01-2018" max="12-31-2050">
									<input type="'.$inputType.'" validValues="'.$validValues.'" fieldId="" tableId="'.$tableId.'" table="'.$rTable.'" id2="'.$inputID.'" class="form-control col-2 '.$textPosition.' inputUdf '.$amount.' udfname udfDateType"  value="' . $value .'" min="01-01-2018" max="12-31-2050" style="color:transparent !important; color: transparent; text-shadow: 0 0 0 #2196f3;" "'.$readonly.'">
