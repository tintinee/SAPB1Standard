		...
		$hasBatchSerial = '';
				...
				if($docType == 'I'){
					...
					'<tr style="background-color: white; "  >
					  ...
					  <td >
						<div class="'.$inputGroup.' ">
						<input type="text" class="form-control matrix-cell whsecode"   style="outline: none; border:none" readonly/  value="'.$WhsName.'">
						<input type="hidden" class="form-control matrix-cell whsename"   style="outline: none; border:none" value="'.$WhsCode.'"/>
						</div>
					  </td>
					   <td >
					   <div class="'.$inputGroup.' ">
					  ...
					  <td>
					  <div class="'.$inputGroup.' ">
					  <input type="text" class="form-control text-right d-none wtliable"  style="outline: none; border:none" maxlength="8"/>
