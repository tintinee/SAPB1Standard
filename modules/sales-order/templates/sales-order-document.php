...
<div id="wrapper">
	...
	$approvalCodes = '';
	$forApproval = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB2."]; 
		SELECT 

		T0.Code
														
		FROM [".$MSSQL_DB2."].[dbo].[@OAPR] T0
		INNER JOIN [".$MSSQL_DB2."].[dbo].[@APR1] T1 ON T0.Code = T1.Code

		WHERE 

		T0.Modules LIKE '%ORDR%'
		AND T1.EmpId = $EmpId

		");
	while (odbc_fetch_row($forApproval)) 
	{
		$approvalCodes .=  "'". odbc_result($forApproval, 'Code') ."'"  . ', ';
	}
	$approvalCodes .= "'". 'ENDER' ."'";
	
	odbc_free_result($forApproval);
 ...
 <div id="content-wrapper" class="d-flex flex-column">
 	...
 	<h1 class="h3 mb-0 text-gray-800 d-none" id="approvalCodes"><?php echo $approvalCodes ?></h1>
 	<!-- Main Content -->
 	<div id="content">
			...
			<div class="col-sm-9">
				<div class="input-group mb-1">
					<div class="input-group-prepend d-none" id="lnkCardCode">
						<button ID="bpMaster" class="btn" type="button" data-mdb-ripple-color="dark"
							style="background-color: #ADD8E6;">
							<i class="fas fa-arrow-right  " style="color: #FFD700; font-size:20px"></i>
						</button>
					</div>
					<input readonly type="text" id="txtCardCode" class="form-control inputRadius" placeholder=""
						aria-label="Username" aria-describedby="basic-addon1 "
						style="border-bottom-left-radius:5px; border-top-left-radius:5px;">
					<div class="input-group-append">

						<button id="btnCardCode" class="btn btnGroup" type="button" data-mdb-ripple-color="dark"
							style="background-color: #ADD8E6; " data-toggle="modal" data-target="#bpModal"
							data-backdrop="false">
...
<div class="form-group row  py-0 my-0">
	...
	<div class="col-sm-9 ">
		<div class="input-group mb-1">
			...
			<input type="text" class="form-control d-none inputRadius" id="txtContactPersonCode" placeholder="" readonly
				style="border-bottom-left-radius:5px; border-top-left-radius:5px;">
			<input type="text" class="form-control" id="txtContactPerson" placeholder="" readonly
			...
			<div id="contactPersonBtn" class="input-group-append d-none">
				<button class="btn btnGroup" type="button" data-mdb-ripple-color="dark"
					style="background-color: #ADD8E6; " data-toggle="modal" data-target="#contactPersonModal"
					data-backdrop="false">
					<i class="fas fa-list-ul input-prefix" tabindex=0 style="color:blue "></i>
				</button>
			</div>
...
$itemno = 1;
	...
	{
	echo '<option class=" series" value='. odbc_result($qry1, "SeriesName").'>'. odbc_result($qry1, "SeriesName") .'
	</option>';
	$itemno2++;
	}
	$itemno3 = 1;
	...
	{
	echo '<option class=" series" value='. odbc_result($qry2, "SeriesName").'>'. odbc_result($qry2, "SeriesName") .'
	</option>';
	$itemno3++;
	}
	...
	odbc_free_result($qry2);
		...
		<div class="col-sm-6">
	<input type="hidden" class="form-control" id="txtDocEntry" placeholder="" readonly>
	<input type="text" class="form-control " id="txtDocNum" placeholder="" value=<?php
...
<div class="form-group row  py-0 my-0">
 	...
 	<!-- <div class="col-sm-6 input-group mb-1 ">
 		...
 		<input type="date" id="txtPostingDate" class="form-control col-2 postingdate"
 			value="<?php echo date('Y-m-d'); ?>" min="01-01-2018" max="12-31-2050"
 			style="color:transparent !important; ">

 	</div>
    -->
    <div class="col-sm-6 input-group mb-1 ">
 		<input type="date" id="txtPostingDate" class="form-control col-12 postingdate"
 			value="<?php echo date('Y-m-d'); ?>" min="01-01-2018" max="12-31-2050">
    </div>
 </div>
...
<div class="form-group row  py-0 my-0">
	...
	<!-- <div class="col-sm-6 input-group mb-1">
		...
		<input type="date" id="txtDeliveryDate" class="form-control col-2 " value="<?php echo date('Y-m-d'); ?>"
			min="01-01-2018" max="12-31-2050" style="color:transparent !important">

	</div>
    -->
    <div class="col-sm-6 input-group mb-1">
		<input type="date" id="txtDeliveryDate" class="form-control col-12 " value="<?php echo date('Y-m-d'); ?>"
			min="01-01-2018" max="12-31-2050">
...
<div class="form-group row  py-0 my-0">
	...
	<!-- <div class="col-sm-6 input-group mb-1">
		...
		<input type="date" id="txtDocumentDate" class="form-control col-2" value="<?php echo date('Y-m-d'); ?>"
			min="01-01-2018" max="12-31-2050" style="color:transparent !important">
			</div> -->
            <div class="col-sm-6 input-group mb-1">
		<input type="date" id="txtDocumentDate" class="form-control col-12" value="<?php echo date('Y-m-d'); ?>"
			min="01-01-2018" max="12-31-2050">
			</div>
		</div>
	</div>
 	...
 	<div class="tab-pane fade show active" id="contents" role="tabpanel" aria-labelledby="contents">
 		<div class="form-group row  mb-0">
 			<div class="col-sm-4 row">
 				...
 				<select id="selTransactionType" class="col-sm-3 form-control-sm mdb-select md-form text-left"
 					searchable="Search here.." style=" !important;outline:none; border-color: #D0D0D0;">
...
<div class="row pr-0 " width="100%">
	<div class="col-lg-5 pb-2">
		<div class="form-group row  py-0 my-0">
			...
			<div class="col-sm-9">
				<div class="input-group mb-1">
					<input readonly type="text" id="txtSalesEmpCode" class="form-control d-none" placeholder=""
						aria-label="Username" aria-describedby="basic-addon1" value="1">
					<input readonly type="text" id="txtSalesEmpName" class="form-control inputRadius" placeholder=""
						aria-label="Username" aria-describedby="basic-addon1"
						style="border-bottom-left-radius:5px; border-top-left-radius:5px;" value="-No Sales Employee-">
					<div class="input-group-append">
						<button class="btn btnGroup" type="button" data-mdb-ripple-color="dark"
							style="background-color: #ADD8E6; hover:" data-toggle="modal" data-target="#salesEmpModal"
							data-backdrop="false">
							<i class="fas fa-list-ul input-prefix" tabindex=0 style="color:blue "></i>
						</button>
					</div>
	...
	<div class="col-sm-9 ">
		<div class="input-group mb-1">
			<div class="input-group-prepend " id="lnkEmployee">
				<button class="btn" type="button" data-mdb-ripple-color="dark" style="background-color: #ADD8E6; hover:"
					data-toggle="modal" data-target="#" data-backdrop="false">
					<i class="fas fa-arrow-right  " style="color: #FFD700; font-size:20px"></i>
				</button>
			</div>
			<input readonly type="text" class="form-control d-none" id="txtOwnerCode" value="<?php echo $EmpId?>">
			<input readonly type="text" class="form-control inputRadius" id="txtOwnerName"
				style="border-bottom-left-radius:5px; border-top-left-radius:5px;" value="<?php echo $UserName?>">
			<div class="input-group-append">
				<button class="btn btnGroup" type="button" data-mdb-ripple-color="dark"
					style="background-color: #ADD8E6; hover:" data-toggle="modal" data-target="#empModal"
					data-backdrop="false">
					<i class="fas fa-list-ul input-prefix" tabindex=0 style="color:blue "></i>
				</button>
			</div>
...
<div class="form-group row  py-0 my-0">
	...
	<div class="col-sm-9 ">
		<textarea type="text" class="form-control " id="txtRemarks" placeholder="" resize='false'
...
<div id="footerButtons" class="form-group row  mt-5 ">
	<div class="col-lg-6 col-md-6 col-sm-6 text-left">
		...
		<button type="button" id="btnUpdate" class="  btn btn-warning btn-rounded d-none"
			style="color:black; font-weight: bold; black;width:250px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);">Update</button>
		<button type="button" id="btnApprove" class="  btn btn-warning btn-rounded "
			style="color: black; font-weight: bold; width:250px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);">Approve</button>
		<button type="button" id="btnReject" class="  btn btn-warning btn-rounded "
			style="color: black; font-weight: bold; width:250px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);">Reject</button>
	...
	<div class="col-lg-6 col-md-6 col-sm-6 text-right">
		<span class="dropdown mr-5">
			<button type="button" id="btnCopyFrom" disabled="disabled" data-toggle="dropdown" aria-haspopup="true"
				aria-expanded="false" class="dropdown-toggle  btn btn-warning btn-rounded dropdown-toggle"
			...
			<ul class="dropdown-menu " aria-labelledby="btnCopyFrom"
				...
				<li><button type="button" id="btnCopyFromSQ" class="dropdown-item"
						style="color: black; font-weight: bold; font-size:15px;" data-toggle="modal"
						data-target="#salesQuotationModal" data-backdrop="false">Sales Quotation</button></li>
			</ul>
		</span>
	<span class="dropdown d-none">
			<button type="button" id="btnCopyTo" type="button" data-toggle="dropdown" aria-haspopup="true"
				aria-expanded="false" class="dropdown-toggle  btn btn-warning btn-rounded dropdown-toggle"
				style="color: black; font-weight: bold; width:250px; background-color: gray; border: 1px black solid">Copy
				To</button>
			<ul class="dropdown-menu " aria-labelledby="btnCopyTo"
				style="color: black; font-weight: bold; width:250px; background-color: #fdfd96;">
				<li class="dropdown-item" style="color: black; font-weight: bold; font-size:15px;">
					Delivery</li>
				<li class="dropdown-item" style="color: black; font-weight: bold; font-size:15px;">A/R
					Invoice</li>
			</ul>
		</span>
	</div>
