			...
			while (odbc_fetch_row($qry)) 
									{
										...
										$TrsfrRef = odbc_result($qry, 'TrsfrSum');
										...
										$htmldetails .= '
														...
														<td align="center">'.odbc_result($qry, 'AcctName').'</td>
...
<title>PAYMENT VOUCHER TRANSFER</title>
								...
								<table width="100%" border="0"  > 
									<thead >
										<tr >
											...
											<td width="10%" style="color:black;font-weight:bold; "><h3><center> </center></h3></td>
											<td width="10%" style="color:black;font-weight:bold; "><h3><center></center></h3></td>
											<td width="20%" class="text-right"style="color:black;font-weight:bold; "><h3 style="color: red">CV No.  '.$CVNo.'</h3></td>
