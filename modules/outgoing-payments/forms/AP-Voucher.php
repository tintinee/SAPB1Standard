		...
		<div class="row">
            <div class="col-lg-12">
				<table width="100%" border="0">
					<tbody>
							<tr>
								<td  width="20%" align="left"><img src="logo.jpg" width="150" height="80"></td>
								<td width="20%" align="left"><h3><span style="color:black;font-weight:bold;">&nbsp;&nbsp;ESPINOSA BUSINESS INCORPORATED</span></h3><br>
