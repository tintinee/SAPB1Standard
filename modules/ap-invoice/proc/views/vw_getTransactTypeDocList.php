...
$docNum = $_POST['docNum'];
	...
	while (odbc_fetch_row($qry)) 
	{
		echo '<tr>
				...
				<td style="width: 1%; white-space: nowrap;" class="docDate">'.SAPDateFormater(odbc_result($qry, 'DocDate')).'</td>
				...
				<td style="width: 1%; white-space: nowrap;" class="docDueDate">'.SAPDateFormater(odbc_result($qry, 'DocDueDate')).'</td>
			  </tr>';
		$itemno++;	  
	}
