		            ...
		            <div class="container-fluid" style="margin-left: 1px !important; padding-left: 1px !important;">
		                ...
		                <div class="card shadow mb-4 " id="windowmain"
		                    ...
		                    <div class="row pr-0 " width="100%">
		                        <div class="col-lg-12" id="containerSystem"
		                                        ...
		                                        <ul class="nav nav-tabs pt-2" id="myTab" role="tablist">
		                                            <li class="nav-item " style="">
		                                                <a class="nav-link active " id="" data-toggle="tab"
		                                                    href="#userContainer" role="tab" aria-controls="contents"
		                                                    aria-selected="true"
		                                                    style="color: black; font-weight:bold">Users</a>
		                                            </li>
		                                            <li class="nav-item " style="">
		                                                <a class="nav-link " id="" data-toggle="tab" href="#customers"
		                                                    role="tab" aria-controls="contents" aria-selected="true"
		                                                    style="color: black; font-weight:bold">Customers</a>
		                                            </li>
		                                        </ul>
		                                        <div class="tab-content" id="myTabContent" style="padding-top: 10px;">
		                                            <!-- ///////////////////////////////////////////////////////////////USER SIDE///////////////////////////////////////////////////////////////////////////////////////// -->

		                                            <div class="tab-pane fade show active" id="userContainer" role="tabpanel"
		                                                ...
		                                                <div class="row pr-0 " width="100%">
		                                                    <div class="col-lg-4 pb-2" id="bpCol">
		                                                        <div class="form-group row  py-0 my-0">
		                                                            <div class="col-sm-3">
		                                                                <label for="inputEmail3" class=" col-form-label "
		                                                                    style="color: black;">Superuser</label>
		                                                            </div>
		                                                            <div class="col-sm-9">
		                                                                <div class="input-group mb-1 ">
		                                                                    <input type="checkbox" id="chkAdmin" class=""
		                                                        ...
		                                                        <div class="form-group row py-0 my-0">
		                                                            <div class="col-sm-3">
		                                                                <label for="inputEmail3" class=" col-form-label "
		                                                                    style="color: black;">User Code</label>
		                                                            </div>
		                                                            <div class="col-sm-9 ">
		                                                                <div class="input-group mb-1">
		                                                                ...
		                                                                <div class="input-group mb-1">
		                                                                    <div class="input-group-prepend d-none"
		                                                                        ...
		                                                                        <button class="btn" type="button"
		                                                                            ...
		                                                                            data-toggle="modal"
		                                                                            data-target="#bpMasterModal"
		                                                                            data-backdrop="false">
		                                                                            <i class="fas fa-arrow-right"
		                                                                                style="color: #FFD700; font-size:20px"></i>
		                                                                        </button>
		                                                                    </div>
		                                                                    <input readonly type="text" id="txtEmpCode"
		                                                                        class="form-control d-none" placeholder=""
		                                                                        aria-label="Username"
		                                                                        aria-describedby="basic-addon1 "
		                                                                        style="border-bottom-left-radius:5px; border-top-left-radius:5px;">
		                                                                    <input readonly type="text" id="txtEmpName"
		                                                                        class="form-control" placeholder=""
		                                                                        aria-label="Username"
		                                                                        aria-describedby="basic-addon1 "
		                                                                        style="border-bottom-left-radius:5px; border-top-left-radius:5px;">
		                                                                    ...
		                                                                    <div class="input-group-append">
		                                                                        <button id="btnCardCode" class="btn btnGroup"
		                                                                            type="button" data-mdb-ripple-color="dark"
		                                                                            style="background-color: #ADD8E6; "
		                                                                            data-toggle="modal"
		                                                                            data-target="#empModal"
		                                                                            data-backdrop="false">
		                                                                            <i class="fas fa-list-ul input-prefix"
		                                                                                tabindex=0 style="color:blue "></i>
		                                                                        </button>
		                                                                    </div>	
		                                                                </div>
		                                                            </div>
		                                                        ...
		                                                        <div class="form-group row  py-0 my-0">
		                                                            <div class="col-sm-3">
		                                                                <label for="inputEmail3" class=" col-form-label "
		                                                                    style="color: black;">Locked</label>
		                                                            </div>
		                                                            <div class="col-sm-9">
		                                                                <div class="input-group mb-1 ">
		                                                                    <input type="checkbox" id="chkLocked" class=""
		                                                                        style="width:30px ; height:30px">
		                                                                </div>
		                                                            </div>
		                                                        </div>
		                                                    ...
		                                                    <div class="col-lg-8 pb-2  " width="100%" id="midCol">
		                                                        <ul class="nav nav-tabs pt-2" id="myTab" role="tablist">
		                                                            <li class="nav-item " style="">
		                                                                <a class="nav-link active " id="" data-toggle="tab"
		                                                                    ...
		                                                                    style="color: black; font-weight:bold">Access</a>
		                                                            </li>
		                                                        ...
		                                                        <div class="tab-content" id="myTabContent"
		                                                            ...
		                                                            <div class="tab-pane fade show active" id="contents"
		                                                                role="tabpanel" aria-labelledby="contents">
		                                                                    ...
		                                                                    <div class="row">
		                                                                        <div class="col-lg-6">
		                                                                            <div class="row users"
		                                                                                ...
		                                                                                <div class="col-lg-12"
		                                                                                    style="background-color:#A8A8A8 !important; margin:5px !important">
		                                                                                    <div class="form-group row py-2 my-2"
		                                                                                        id="">
		                                                                                        <div class="col-8">
		                                                                                            <label for="inputEmail3"
		                                                                                                class=" col-form-label "
		                                                                                                style="color: black; font-size:20px !important">General
		                                                                                                Settings</label>
		                                                                                        </div>
		                                                                                        <div class="col-4 text-right">
		                                                                                            <div
		                                                                                                ...
		                                                                                                <button
		                                                                                                    class="btn btnGroup ml-1 mainModule"
		                                                                                                    type="button"
		                                                                                                    id="GenSet"
		                                                                                                    style="background-color: white ;width:40px  !important; height:40px !important ">
		                                                                                                    <i class="checked d-none fas fa-check input-prefix"
		                                                                                                        style="color:blue "
		                                                                                                        val="hehe"></i>
		                                                                                                    <i class="indetermine d-none fas fa-minus input-prefix"
		                                                                                                        style="color:blue "></i>
		                                                                                                    <i class="unchecked d-none fas input-prefix"
		                                                                                                        style="color:blue "></i>
		                                                                                                </button>

		                                                                                                <button
		                                                                                                    class="btn btnGroup ml-1"
		                                                                                                    type="button"
		                                                                                                    data-mdb-ripple-color="dark"
		                                                                                                    style="background-color: #ADD8E6; width:40px  !important; height:40px !important "
		                                                                                                    data-toggle="collapse"
		                                                                                                    data-target="#generalSettings">
		                                                                                                    <i class="fas fa-plus input-prefix"
		                                                                                                        tabindex=0
		                                                                                                        style="color:blue "></i>
		                                                                                                </button>
		                                                                                                ...
		                                                                                                <div class="row ">
		                                                                                                    <div
		                                                                                                        ...
		                                                                                                        <label
		                                                                                                            for="inputEmail3"
		                                                                                                            class=" col-form-label "
		                                                                                                            style="color: black;">Cancellation
		                                                                                                            of
		                                                                                                            Document</label>
		                                                                                                    </div>
		                                                                                                    <button
		                                                                                                        class="btn btn-sm btnGroup ml-1 gensub subModule"
		                                                                                                        type="button"
		                                                                                                        id="CANCEL"
		                                                                                                        style="background-color: white ;width:30px  !important; height:30px !important ">
		                                                                                                        <i class="checked-sub d-none fas fa-check input-prefix"
		                                                                                                            style="color:blue "></i>
		                                                                                                        <i class="unchecked-sub d-none fas input-prefix"
		                                                                                                            style="color:blue "></i>
		                                                                                                    </button>
		                                                                                                </div>
		                                                                                                <div class="row">
		                                                                                                ...
		                                                                                                <div class="row">
		                                                                                                    <div
		                                                                                                        ...
		                                                                                                        <label
		                                                                                                            for="inputEmail3"
		                                                                                                            class=" col-form-label "
		                                                                                                            style="color: black;">Approval</label>
		                                                                                                    </div>
		                                                                                                    <button
		                                                                                                        class="btn btn-sm btnGroup ml-1 gensub subModule"
		                                                                                                        type="button"
		                                                                                ...
		                                                                                <div class="col-lg-12"
		                                                                                    style="background-color:#A8A8A8 !important; margin:5px !important">
		                                                                                    <div
		                                                                                        class="form-group row py-2 my-2">
		                                                                                        <div class="col-8">
		                                                                                            <label for="inputEmail3"
		                                                                                                class=" col-form-label "
		                                                                                                style="color: black; font-size:20px !important">Financials
		                                                                                                Module</label>
		                                                                                        </div>
		                                                                                        <div class="col-4 text-right">
		                                                                                            <div
		                                                                                                ...
		                                                                                                <div class="row">
		                                                                                                    <div
		                                                                                                        ...
		                                                                                                        <label
		                                                                                                            for="inputEmail3"
		                                                                                                            class=" col-form-label "
		                                                                                                            style="color: black;">Journal
		                                                                                                            Entry</label>
		                                                                                                    </div>
		                                                                                                    <button
		                                                                                                        class="btn btn-sm btnGroup ml-1 finsub subModule"
		                                                                                                        type="button"
		                                                                                                        id="OJDT"
		                                                                                                        style="background-color: white ;width:30px  !important; height:30px !important ">
		                                                                                                        <i class="checked-sub d-none fas fa-check input-prefix"
		                                                                                ...
		                                                                                <div class="col-lg-12"
		                                                                                    ...
		                                                                                    <div
		                                                                                        ...
		                                                                                        <div class="col-8">
		                                                                                            <label for="inputEmail3"
		                                                                                                class=" col-form-label "
		                                                                                                style="color: black; font-size:20px !important">Inventory
		                                                                                                Module</label>
		                                                                                        </div>
		                                                                                        <div class="col-4 text-right">
		                                                                                            <div
		                                                                                                ...
		                                                                                                <div class="row">
		                                                                                                    <div
		                                                                                                        ...
		                                                                                                        <label
		                                                                                                            for="inputEmail3"
		                                                                                                            class=" col-form-label "
		                                                                                                            style="color: black;">Goods
		                                                                                                            Receipt</label>
		                                                                                                    </div>
		                                                                                                    <button
		                                                                                                        class="btn btn-sm btnGroup ml-1 invsub subModule"
		                                                                                                        type="button"
		                                                                                                        id="OIGN"
		                                                                                                        style="background-color: white ;width:30px  !important; height:30px !important ">
		                                                                                                        <i class="checked-sub d-none fas fa-check input-prefix"
		                                                                                ...
		                                                                                <div class="col-lg-12"
		                                                                                    ...
		                                                                                    <div
		                                                                                        ...
		                                                                                        <div class="col-8">
		                                                                                            <label for="inputEmail3"
		                                                                                                class=" col-form-label "
		                                                                                                style="color: black; font-size:20px !important">Sales
		                                                                                                Module</label>
		                                                                                        </div>
		                                                                                        <div class="col-4 text-right">
		                                                                                            <div
		                                                                                        ...
		                                                                                        <div class="col-12 "
		                                                                                            ...
		                                                                                            <div class="collapse ml-2 mt-3"
		                                                                                                ...
		                                                                                                <div class="row ">
		                                                                                                    ...
		                                                                                                    <button
		                                                                                                        class="btn btn-sm btnGroup ml-1 salessub subModule"
		                                                                                                        type="button"
		                                                                                                        id="OQUT"
		                                                                                                        style="background-color: white ;width:30px  !important; height:30px !important ">
		                                                                                                        <i class="checked-sub d-none fas fa-check input-prefix"
		                                                                                                ...
		                                                                                                <div class="row">
		                                                                                                    <div
		                                                                                                        ...
		                                                                                                        <label
		                                                                                                            for="inputEmail3"
		                                                                                                            class=" col-form-label "
		                                                                                                            style="color: black;">Delivery</label>
		                                                                                                    </div>
		                                                                                                    <button
		                                                                                                        class="btn btn-sm btnGroup ml-1 salessub subModule"
		                                                                                                        type="button"
		                                                                                ...
		                                                                                <div class="col-lg-12"
		                                                                                    ...
		                                                                                    <div
		                                                                                        ...
		                                                                                        <div class="col-8">
		                                                                                            <label for="inputEmail3"
		                                                                                                class=" col-form-label "
		                                                                                                style="color: black; font-size:20px !important">Purchase
		                                                                                                Module</label>
		                                                                                        </div>
		                                                                                        <div class="col-4 text-right">
		                                                                                            <div
		                                                                                        ...
		                                                                                        <div class="col-12 "
		                                                                                            ...
		                                                                                            <div class="collapse ml-2 mt-3"
		                                                                                                ...
		                                                                                                <div class="row">
		                                                                                                    ...
		                                                                                                    <button
		                                                                                                        class="btn btn-sm btnGroup ml-1 purchsub subModule"
		                                                                                                        type="button"
		                                                                                                        id="OPRQ"
		                                                                                                        style="background-color: white ;width:30px  !important; height:30px !important ">
		                                                                                                        <i class="checked-sub d-none fas fa-check input-prefix"
																										...
																										<div class="row">
		                                                                                                    <div
		                                                                                                        ...
		                                                                                                        <label
		                                                                                                            for="inputEmail3"
		                                                                                                            class=" col-form-label "
		                                                                                                            style="color: black;">AP Downpayment
		                                                                                                            Invoice</label>
		                                                                                                    </div>
		                                                                                                    <button
		                                                                                                        class="btn btn-sm btnGroup ml-1 purchsub subModule"
		                                                                                ...
		                                                                                <div class="col-lg-12"
		                                                                                    ...
		                                                                                    <div
		                                                                                        ...
		                                                                                        <div class="col-8">
		                                                                                            <label for="inputEmail3"
		                                                                                                class=" col-form-label "
		                                                                                                style="color: black; font-size:20px !important">Banking
		                                                                                                Module</label>
		                                                                                        </div>
		                                                                                        <div class="col-4 text-right">
		                                                                                            <div
		                                                                                                ...
		                                                                                                <div class="row">
		                                                                                                    <div
		                                                                                                        ...
		                                                                                                        <label
		                                                                                                            for="inputEmail3"
		                                                                                                            class=" col-form-label "
		                                                                                                            style="color: black;">Incoming
		                                                                                                            Payment</label>
		                                                                                                    </div>
		                                                                                                    <button
		                                                                                                        class="btn btn-sm btnGroup ml-1 banksub subModule"
		                                                                                                        type="button"
		                                                                                                        id="ORCT"
		                                                                                                        style="background-color: white ;width:30px  !important; height:30px !important ">
		                                                                                                        <i class="checked-sub d-none fas fa-check input-prefix"
		                                                            ...
		                                                            <div class="tab-pane fade " id="accounting"
		                                                                role="tabpanel" aria-labelledby="accounting">
		                                                                <div id="contentContainer" class="table-responsive"
		                                                            ...
		                                                            <div class="tab-pane fade " id="attachments"
		                                                                role="tabpanel" aria-labelledby="attachments">
		                                                                <div id="contentContainer" class="table-responsive"
		                                                                    style="width:100%; padding-bottom:20px; padding-left:10px; padding-right:10px;  overflow-x:hidden;  overflow-y:hidden;">
		                                                ...
		                                                <div id="userContainer" class="table-responsive"
		                                                    style="width:100%; padding-bottom:20px; padding-left:10px;  overflow-x:hidden;  overflow-y:hidden;">
		                                                    ...
		                                                    <div id="footerButtons" class="form-group row  mt-5 ">
		                                                        <div class="col-lg-6 col-md-6 col-sm-6 text-left">
		                                                            ...
		                                                            <button type="button" id="btnUpdateUser"
		                                                            ...
		                                                            <button type="button" id="btnOkUser"
		                                                                class="  btn btn-warning btn-rounded d-none"
		                        ...
		                        <!-- ///////////////////////////////////////////////////////////////CUSTOMER SIDE///////////////////////////////////////////////////////////////////////////////////////// -->
		                        <div class="tab-pane fade show " id="customers" role="tabpanel" aria-labelledby="contents">
		                            <div class="row pr-0 " width="100%">
		                                <div class="col-lg-4 pb-2" id="bpCol">
		                                    ...
		                                    <div class="form-group row py-0 my-0">
		                                        <div class="col-sm-3">
		                                            <label for="inputEmail3" class=" col-form-label "
		                                                style="color: black;">Customer Code</label>
		                                        </div>
		                                        <div class="col-sm-9 ">
		                                            <div class="input-group mb-1">
		                                                ...
		                                                <div class="input-group-append">
		                                                    <button id="btnCardCode" class="btn btnGroup" type="button"
		                                                        ...
		                                                        data-target="#custModal" data-backdrop="false">
		                                    ...
		                                    <div class="form-group row  py-0 my-0">
		                                        <div class="col-sm-3">
		                                            <label for="inputEmail3" class=" col-form-label "
		                                                style="color: black;">Customer Name</label>
		                                        </div>
		                                        <div class="col-sm-9">
		                                            <div class="input-group mb-1">
		                                    ...
		                                    <div class="form-group row  py-0 my-0">
		                                        ...
		                                        <div class="col-sm-9">
		                                            <div class="input-group mb-1">
		                                                <input type="password" id="txtCustPassword" class="form-control"
		                                ...
		                                <div id="userContainer" class="table-responsive"
		                                    ...
		                                    <div id="footerButtons" class="form-group row  mt-5 ">
		                                        <div class="col-lg-6 col-md-6 col-sm-6 text-left">
		                                            <button type="button" id="btnAddCust"
		                                                class="  btn btn-warning btn-rounded "
		                                                style="color: black; font-weight: bold; width:250px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);">Add</button>
		                                            <button type="button" id="btnUpdateCust"
		                                                class="  btn btn-warning btn-rounded d-none"
		                                                style="color:black; font-weight: bold; black;width:250px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);">Update</button>
		                                            <button type="button" id="btnOkCust"
		                                                class="  btn btn-warning btn-rounded d-none"
		                                                style="color:black; font-weight: bold; black;width:250px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);">Ok</button>

		                                            <button type="button" id="btnCancelCust"
		                                                class=" btn btn-warning btn-rounded ml-5"
		                                                style="color: black;width:250px; font-weight: bold; background: linear-gradient(to bottom, #FCF6BA, #BF953F);">Cancel</button>
		                                        </div>
		                                    </div>
		    ...
		    <div class="modal-dialog modal-xl" role="document" style="width:100%">
		        ...
		        <div class="modal-content-full-width modal-content">
		            ...
		            <div class="modal-header"
		                style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e; ">
		                <h4 class="modal-title w-100" id="myModalLabel" style="color:black; font-size:15px !important;">Logout
		                </h4>
		...
		<div class="modal fade" id="empModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		    <div class="modal-dialog modal-xl" role="document" style="width:100%">
		        ...
		        <div class="modal-content-full-width modal-content">
		            ...
		            <!--Body-->
		            <div class="modal-body">
		                <table class="tblBP table table-striped table-bordered table-hover" id="tblEmployee"
		                    style="width: 100%">
		                    <thead>
		                        <tr>
		                            <th>#</th>
		...
		<div class="modal fade" id="custModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		    <div class="modal-dialog modal-xl" role="document" style="width:100%">
		        ...
		        <div class="modal-content-full-width modal-content">
		            ...
		            <!--Body-->
		            <div class="modal-body">
		                <table class="tblBP table table-striped table-bordered table-hover" id="tblCustomer"
		                    style="width: 100%">
		                    <thead>
		                        <tr>
		                            <th>#</th>
							...
							$qry = odbc_exec($MSSQL_CONN, "USE [".$MSSQL_DB."]; SELECT DISTINCT
								...
								while (odbc_fetch_row($qry)) 
								{
									echo '<tr class="tableHover">
												...
												<td class="item-5">'.odbc_result($qry, 'CardCode').'</td>
												<td class="item-2">'.odbc_result($qry, 'CardName').'</td>
												<td class="item-3">'.odbc_result($qry, 'Address').'</td>
												<td class="item-4">'.odbc_result($qry, 'MailAddres').'</td>
										</tr>';
									$itemno++;	  
								}
		    ...
		    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document"
		        ...
		        <div class="modal-content-full-width modal-content" style="height: 500px;">
		            ...
		            <div class="modal-body">
		                ...
		                <div class="form-group row   my-1">
		                    <label for="inputEmail3" class="col-sm-3 col-form-label py-1 mt-2" style="color: black;">Building
		                        / Floor / Room</label>
		                    <div class="col-sm-9">
