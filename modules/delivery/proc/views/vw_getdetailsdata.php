				...
				if($docType == 'I'){
					...
					'<tr style="background-color: white; "  >
					  ...
					  <td >
						...
						<input type="hidden" class="form-control matrix-cell uomgroup"   style="outline: none; border:none" value="'.$UomCode.'" />
						</div>
					  </td>
					  <td >
						<div class="'.$inputGroup.' ">
						<input type="text" class="form-control matrix-cell unitmsr"  style="outline: none; border:none" value="'.$UnitMsr.'" readonly/>
					  ...
					  <td >
						<div class="'.$inputGroup.' ">
						<input type="text" class="form-control matrix-cell whsename"   style="outline: none; border:none" readonly  value="'.$WhsName.'"/>
						<input type="hidden" class="form-control matrix-cell whsecode"   style="outline: none; border:none" value="'.$WhsCode.'"/>
						</div>
					  </td>
					   <td >
					   <div class="'.$inputGroup.' ">
	...
	if($objType == 22){
		...
		if($docType == 'I'){
					...
					'<tr style="background-color: white; "  >
					  ...
					  <td >
					  <div class="'.$inputGroup.' ">
					  <input type="text" class="form-control matrix-cell whsename"   style="outline: none; border:none" readonly/>
					  <input type="hidden" class="form-control matrix-cell whsecode"   style="outline: none; border:none" />
					  </div>
					</td>
					   <td >
					   <div class="'.$inputGroup.' ">
