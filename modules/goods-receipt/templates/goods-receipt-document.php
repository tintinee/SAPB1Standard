...
<div id="wrapper">
                            ...
                            <div class="card-body " id="window"
                                ...
                                <form class="user responsive " id="salesOrder" width="100%">
                                    <div class="row pr-0 " width="100%">
                                        ...
                                        <div class="col-lg-3 pb-2  " width="100%" id="midCol"></div>
                                    ...
                                    <div class="row pr-0 " width="100%">
                                        ...
                                        <div class="col-lg-8 pb-2  " width="100%" id="midCol">
                                            <div class="form-group row  py-0 my-0 mb-1">
                                                ...
                                                <div class="col-sm-7">
                                                    <select type="text" class="form-control " id="selPriceList"
                                                        placeholder="">
                                                        <option class="pricelist" value='-1'>Last Purchase Price
                                                        </option>
                                                        <option class="pricelist" value='-2'>Last Evaluated Price
                                                        </option>
                                                        <?php
										$itemno = 1;
                                    ...
                                    <div id="footerButtons" class="form-group row  mt-5 ">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 text-right">
                                            <span class="dropdown mr-5">
                                                <button type="button" id="btnCopyFrom" data-toggle="dropdown"
                                                ...
                                                <ul class="dropdown-menu " aria-labelledby="btnCopyFrom"
                                                    ...
                                                    <li><button type="button" id="btnCopyFromPO" class="dropdown-item"
                                                            ...
                                                            data-toggle="modal" data-target="#goodsIssueModal"
                                                            data-backdrop="false">Goods Issue</button></li>
                                                </ul>
                                            </span>
                                        </div>
    ...
    <div class="modal fade" id="documentModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog modal-xl" role="document" style="width:100%">
            ...
            <div class="modal-content-full-width modal-content">
                ...
                <div class="modal-header"
                    style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
                    <h4 class="modal-title w-100" id="myModalLabel" style="color:black">List of Goods Receipt </h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <!-- Copy From PO Modal -->
    <div class="modal fade" id="goodsIssueModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document" style="width:100%">
            <!--Content-->
            <div class="modal-content-full-width modal-content">
            ...
            <div class="modal-content-full-width modal-content"
                ...
                <div class="modal-body ">
                    ...
                    <div id="batchTableReport" class="table-responsive"
                        style="width:100%; height:500px !important; padding-bottom:20px; padding-left:10px;  overflow:scroll;">
