...
<div id="wrapper">
                                ...
                                <form class="user responsive " id="salesOrder" width="100%">
                                            ...
                                            <div class="form-group row  py-0 my-0">
                                                <div class="col-sm-4">
                                                    <label for="inputEmail3" class=" col-form-label "
                                                        style="color: black;">Number</label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class=" mb-1">
                                        ...
                                        <div class="col-lg-8 pb-2  " width="100%" id="midCol">
                                            <div class="form-group row  py-0 my-0 mb-1">
                                                <label for="inputEmail3" class="col-sm-1 col-form-label "
                                                    style="color: black;">Price List</label>
                                                <div class="col-sm-7">
                                                    <select type="text" class="form-control " id="selSeries"
                                                        placeholder="">
									...
									?>
                                        ...
                                        <div class="col-lg-4 pb-2 " id="dateCol">
                                            ...
                                            <div class="form-group row  py-0 my-0 mb-1">
                                                <label for="inputEmail3" class="col-sm-5 col-form-label "
                                                    style="color: black;">Ref. 2</label>
                                                <div class="col-sm-1 ">
                                                </div>
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control d-none" id="txtStatus"
                                                        placeholder="" value="" readonly>
                                                    <input type="text" class="form-control" id="TestRef" placeholder=""
                                                        value="">
                                                </div>
                                            </div>
                                    ...
                                    <ul class="nav nav-tabs pt-2" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link d-none" id="" data-toggle="tab" href="#logistics"
                                                role="tab" aria-controls="logistics" aria-selected="false"
                                                style="color: black; font-weight:bold">Logistics</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link d-none" id="" data-toggle="tab" href="#accounting"
                                    ...
                                    <div class="tab-content" id="myTabContent"
                                        style="padding-top: 10px; padding-bottom: 100px !important">
    ...
    <div class="modal fade" id="documentModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog modal-xl" role="document" style="width:100%">
            ...
            <div class="modal-content-full-width modal-content">
                ...
                <div class="modal-header"
                    style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
                    <h4 class="modal-title w-100" id="myModalLabel" style="color:black">List of Goods issue</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade" id="batchModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document"
            ...
            <!--Content-->
            <div class="modal-content-full-width modal-content"
                style="height:1200px; width:1500px !important; margin-bottom:50px">
                <!--Header-->
                <div class="modal-header"
                    style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
                ...
                <div class="modal-body">
                    ...
                    <div id="batchTable" class="table-responsive mb-3"
                        style="width:100%; height:400px !important; padding-bottom:20px; padding-left:10px;  overflow:scroll;">
                    ...
                    <div class="row" style="width:100%">
                        <p id="batchTitle2" style="color:black; font-weight:bold; padding-left:10px;">Transactions for
                            Batch</p>
                        <div id="batchTableReportAdded" class="table-responsive "
                        ...
                        <div class="col-6" id="batchTableReportTaggingAvailable">
                            <p id="batchTitle4" style="color:black; font-weight:bold; padding-left:10px;">Available
                                Batches</p>
                            <div class="table-responsive"
                                style="width:100%; height:300px !important;  padding-left:10px;  overflow:scroll;">


                                <table id="tblBatchAvailable"
                                    class="table table-striped table-bordered table-sm detailsTable" cellspacing="0"
                        ...
                        <div class="col-1 text-center" id="batchTableReportTaggingButtons">
                            <div class="text-center" style=" margin-top:50px !important">
                                <button type="button" id="btnSelectBatch" class="  btn btn-warning btn-rounded "
                                    style="color: black; font-weight: bold; width:50px; background: linear-gradient(to bottom, #FCF6BA, #BF953F); margin-top:90px !important">&gt;</button>
                                <button type="button" id="btnUnselectBatch" class="  btn btn-warning btn-rounded "
                                    style="color: black; font-weight: bold; width:50px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);  margin-top:20px !important">&lt;</button>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document"
            ...
            <div class="modal-content-full-width modal-content"
                ...
                <div class="modal-body ">
                    ...
                    <div class="row" style="width:100%">
                        <p id="serialtitle4" style="color:black; font-weight:bold; padding-left:10px;" class="d-none">
                            Transactions for Serial</p>
                        <div id="serialTableReportAdded" class="table-responsive "
                            style="width:100%; height:300px !important; padding-bottom:20px; padding-left:10px;  overflow:scroll;">
                        </div>
                        ...
                        <div class="col-1 text-center" id="serialTableReportTaggingButtons">
                            <div class="text-center" style=" margin-top:50px !important">
                                <button type="button" id="btnSelectSerial" class="  btn btn-warning btn-rounded "
                                    style="color: black; font-weight: bold; width:50px; background: linear-gradient(to bottom, #FCF6BA, #BF953F); margin-top:90px !important">&gt;</button>
                                <button type="button" id="btnUnselectSerial" class="  btn btn-warning btn-rounded "
                                    style="color: black; font-weight: bold; width:50px; background: linear-gradient(to bottom, #FCF6BA, #BF953F);  margin-top:20px !important">&lt;</button>
                            </div>
                        </div>
                                ...
                                <table id="tblSerialSelected"
                                    ...
                                    <thead>
                                        <tr>
                                            <th style="min-width:20px;position: sticky;top: 0; ">#</th>
                                            <th style="min-width:150px;position: sticky;top: 0; ">Serial Number</th>
                                            <th style="min-width:150px;position: sticky;top: 0; " class="d-none">
                                                Quantity</th>
                                        </tr>
                                    </thead>
                                    <tbody>
