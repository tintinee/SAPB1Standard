    ...
    <table id="tblDetails" class="table table-striped table-bordered table-sm detailsTable" cellspacing="0"
        ...
        <thead style="border-bottom: 0 !important">
            <tr>
                ...
                <th style="color: black; min-width:200px;">Inventory UoM</th>
            ...
            <tr style="background-color: white; ">
                ...
                <td>
                    <div class="input-group ">
                        ...
                        <input type="hidden" class="form-control batchorserial" aria-label="Recipient's username"
                            aria-describedby="button-addon2" style="outline: none; border:none; " readonly />
                        <input type="hidden" class="form-control batchorserialcontainer"
                            aria-label="Recipient's username" aria-describedby="button-addon2"
                            style="outline: none; border:none; " readonly />
                        <input type="hidden" class="form-control batchorserialcontainer2"
                            aria-label="Recipient's username" aria-describedby="button-addon2"
                            style="outline: none; border:none; " readonly />

                        <input type="hidden" class="form-control batchorserialqtycreated"
                            aria-label="Recipient's username" aria-describedby="button-addon2"
                            style="outline: none; border:none; " readonly />
                        <input type="hidden" class="form-control batchorserialexpdate" aria-label="Recipient's username"
                            aria-describedby="button-addon2" style="outline: none; border:none; " readonly />
                        <input type="hidden" class="form-control batchorserialmfrdate" aria-label="Recipient's username"
                            aria-describedby="button-addon2" style="outline: none; border:none; " readonly />
                        <input type="hidden" class="form-control batchorserialadmindate"
                            aria-label="Recipient's username" aria-describedby="button-addon2"
                            style="outline: none; border:none; " readonly />
                        <input type="hidden" class="form-control batchorseriallocation"
                            aria-label="Recipient's username" aria-describedby="button-addon2"
                            style="outline: none; border:none; " readonly />
                        <input type="hidden" class="form-control batchorserialdetails" aria-label="Recipient's username"
                            aria-describedby="button-addon2" style="outline: none; border:none; " readonly />
                        <input type="hidden" class="form-control batchorserialunitcost"
                            aria-label="Recipient's username" aria-describedby="button-addon2"
                            style="outline: none; border:none; " readonly />
                ...
                <td>
                    <div class="input-group ">
                        <select disabled type="text" class="form-control matrix-cell inventoryuom" style="outline:none;border:none">
                ...
                <td>
                    <div class="input-group ">
                        <input type="text" class="form-control matrix-cell unitmsr" style="outline: none; border:none"
                            readonly />
                        <button class="btn d-none btnunitmsr     " type="button" data-mdb-ripple-color="dark"
                ...
                <td>
                    <div class="input-group ">
                        <input type="text" class="form-control matrix-cell whsecode" style="outline: none; border:none"
                            readonly />
                        <button class="btn " type="button" data-mdb-ripple-color="dark"
                            style="background-color: #ADD8E6; " data-toggle="modal" data-target="#whseModal"
                            data-backdrop="false">
                            <i class="fas fa-list-ul input-prefix" tabindex=0 style="color:blue "></i>
                        </button>
                        <input type="hidden" class="form-control matrix-cell whsename" aria-label="Recipient's username"
                            aria-describedby="button-addon2" style="outline: none; border:none" />
                    </div>
                <td>
                    <div class="input-group ">
                ...
                <td>
                    <div class="input-group ">
                        ...
                        <input type="hidden" class="form-control matrix-cell text-right batchorserialquantity"
                            aria-label="" aria-describedby="button-addon2" style="outline: none; border:none"
                            maxlength="12" />

                        <button class="btn btn-batch d-none" type="button" data-mdb-ripple-color="dark"
                            style="background-color: #ADD8E6; " data-toggle="modal" data-target="#batchModal"
                            data-backdrop="false">
                            <i class="fas fa-list-ul input-prefix" tabindex=0 style="color:blue "></i>
                        </button>
                        <button class="btn btn-serial d-none" type="button" data-mdb-ripple-color="dark"
                            style="background-color: #ADD8E6; " data-toggle="modal" data-target="#serialModal"
                            data-backdrop="false">
                            <i class="fas fa-list-ul input-prefix" tabindex=0 style="color:blue "></i>
                        </button>
                        <button class="btn btn-disabled d-none" disabled type="button" data-mdb-ripple-color="dark"
                            style="background-color: lightgray; " data-toggle="modal" data-target="#"
                            data-backdrop="false">
                ...
                <td class="d-none">
                    <input type="text" class="form-control matrix-cell text-right grossprice"
