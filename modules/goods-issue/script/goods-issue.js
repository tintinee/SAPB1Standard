...
//Double Clicks
	...
	$(document.body).on('dblclick', '#tblItem tbody > tr', function () 
	{
		...
		//Inventory UoM Statment
		if (uomEntry  > 0) {
			// alert("show ");
			$('.selected-det').find('select.inventoryuom').prop('disabled', false);
		  } else if (uomEntry  == -1) {
			// alert(" readonly");
			$('.selected-det').find('select.inventoryuom').prop('disabled', true);
...
//On Change
	...
	$(document.body).on('change', '#txtPostingDate', function () 
	{
		...
		// $('#txtPostingDate').val(newdate);

		// var dateInput = document.getElementById("txtPostingDate");
		// var dateValue = dateInput.value;
		// var newDateString = dateValue.replace(/\//g, ".");
	...
	// 	  var dateValue = $(this).val();
	// 	  var newDateValue = dateValue.split('/').join(',');
	...
	// 3
	//   $(document).on('input', '#txtPostingDate', function() {
	// 	var dateValue = $(this).val();
	// 	var newDateValue = dateValue.split('/').join('.');
	// 	$(this).val(newDateValue);
	...
	//function Inventory UoM 
	$(document.body).on('change', '.inventoryuom', function()
	{
		let inventoryuom = $(this).val()
		let btnUoM = document.getElementById("btnUoM");
		


		if(inventoryuom == "Yes"){
			// $(".unitmsr").prop("readonly", true);
			console.log(inventoryuom)
			// $('.selected-det').find('button').addClass('d-none');
			//$('#btnUoM').addClass('d-none')
			$('.selected-det').find('.unitmsr').prop("readonly", true);
			$('.selected-det').find('button.btnunitmsr').addClass('d-none');

		} else if(inventoryuom == "No"){
			console.log(inventoryuom)
			
			// $(".unitmsr").prop("readonly", false);
			$('.selected-det').find('.unitmsr').prop("readonly", false);
			$('.selected-det').find('button.btnunitmsr').removeClass('d-none');
