...
?>
	<tr style="background-color: white; "  >
		...
		<td >
			<input type="number" class="form-control matrix-cell text-right quantity"  aria-label="" aria-describedby="button-addon2" style="outline: none; border:none" maxlength="12"/>	
		</td>
		<td >
