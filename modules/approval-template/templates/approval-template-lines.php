...
<table id="tblDetails" class="table table-striped table-bordered table-sm detailsTable" cellspacing="0"  style="background-color: white; width= 100%" cellspacing="0">
  ...
  <tbody class="">
    <tr style="background-color: white; "  >
      ...
      <td >
				<input type="text" class="form-control approverid"  aria-label="Recipient's username" aria-describedby="button-addon2" style="outline: none; border:none; " readonly/>
	  	</td>
		  <td >
				<div class="input-group ">
					<input type="text" class="form-control matrix-cell approvername"  aria-label="Recipient's username" aria-describedby="button-addon2" style="outline: none; border:none" readonly/>
					  <button class="btn " type="button" data-mdb-ripple-color="dark"  style="background-color: #ADD8E6; "  data-toggle="modal" data-target="#ApproverModal" data-backdrop="false">
...
<script>$('#tblAprrovalTemplate').dataTable({
      scrollX: false,
      scroller: true,
			searching: false,
			ordering: false,
