      ...
      <div id="content" >
	   ...
	   ?>
        ...
        <div class="container-fluid" style="margin-left: 1px !important; padding-left: 1px !important;">
          ...
          <!-- DataTales Example -->
          <div class="card shadow mb-4 col-lg-10"  id="windowmain" style="background-color:#E8E8E8 !important; border: none !important" >
		  <div class="row pr-0 "  width="100%">
            ...
            <div class="card-header py-0" style="background-color: #A8A8A8; border-bottom-width: thick; border-color: #f0ad4e;">
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6">
						<h5 class="mt-2 font-weight-bold " style="color: black;">License Management</h5>
					</div>
			...
			<form class="user responsive " id="salesOrder"  width="100%">
				...
				<div class="col-lg-4 pb-2" id="bpCol">
					...
					<div class="col-lg-3 mt-5 pt-5  "  width="100%" id="midCol">
						<div class="form-group row py-0 my-0" >
							<div class="col-sm-4" >
					...
					<div class="col-lg-1 mt-5 pt-5  "  width="100%" id="midCol">
						<div class="form-group row  py-0 my-0">
						
						<div class="col-sm-6" >
							<div class="input-group mb-1 ">
								<label for="inputEmail3" class=" col-form-label mr-2" style="color: black;" >Used</label>
								<input  type="checkbox" id="chkAdmin" class="" style="width:37px ; height:37px" >
							</div>
						</div>	  
						<div class="col-sm-6" >
							<div class="input-group mb-1 ">
								<label for="inputEmail3" class=" col-form-label mr-2" style="color: black;" >Available</label>
								<input  type="checkbox" id="chkAdmin" class="" style="width:37px ; height:37px" >
							</div>
						</div>	  
					</div>
