...
<table id="tblDetails" class="table table-striped table-bordered table-sm detailsTable" cellspacing="0"  style="background-color: white; width= 100%" cellspacing="0">
  <thead   style="border-bottom: 0 !important; width= 100%"  >
    <tr>
	  ...
	  <th style="color: black; min-width:250px;">From Warehouse</th>
	  <th style="color: black; min-width:250px;">To Warehouse</th>
      <th style="color: black; min-width:200px;">UoM Code</th>
	  <th style="color: black; width:100px; min-width:150px;">Quantity</th>
	  <th style="color: black; min-width:150px;" >Item Cost</th>
  ...
  <tbody class="" >
    <tr style="background-color: white;"   >
	  ...
	  <td >
		<div class="input-group ">
		<input type="text" class="form-control matrix-cell fromwhsename"  aria-label="Recipient's username" aria-describedby="button-addon2" style="outline: none; border:none" readonly/>
		...
		<input type="hidden" class="form-control matrix-cell fromwhsecode"  aria-label="Recipient's username" aria-describedby="button-addon2" style="outline: none; border:none" readonly/>
		</div>
	  </td>
	    <td >
		<div class="input-group ">
		<input type="text" class="form-control matrix-cell towhsename"  aria-label="Recipient's username" aria-describedby="button-addon2" style="outline: none; border:none" readonly/>
		...
		<input type="hidden" class="form-control matrix-cell towhsecode"  aria-label="Recipient's username" aria-describedby="button-addon2" style="outline: none; border:none" readonly/>
		</div>
	  </td>
	  <td >
		<div class="">
  ...
  <tfoot style="z-index: 999;  background-color: lightgray; " class="d-none">
		<tr style="background-color: lightgray; z-index: 999">
		 <th class="text-right" style=" color: black; max-width:10px;">#</th>
		  <th style="color: black; min-width:300px; ">Item No.</th>
		  <th style="color: black; min-width:400px;" >Item Description</th>
		  <th style="color: black; min-width:250px;">From Warehouse</th>
		  <th style="color: black; min-width:250px;">To Warehouse</th>
