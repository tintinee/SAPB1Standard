...
<table id="tblDetails" class="table table-striped table-bordered table-sm detailsTable" cellspacing="0"  style="background-color: white; width=100% !important;"  cellspacing="0">
  <thead   style="border-bottom: 0 !important; ">
    <tr >
      ...
      <th style="color: black; min-width:350px;" >Item Description</th>
      <th style="color: black; min-width:100px;">UoM Code</th>
	  <th style="color: black; min-width:100px;">Quantity</th>
	  <th style="color: black; min-width:350px;">Unit Price</th>
	  <th style="color: black; min-width:100px;">Discount %</th>
      <th style="color: black; min-width:0px" class="d-none"></th>
	  <th style="color: black; min-width:250px;">Gross Price</th>
      <th style="color: black;  min-width:0px" class="d-none"></th>
	  <th style="color: black; min-width:300px; ">Gross Total</th>
    </tr>
  </thead>
  <tbody class="">
